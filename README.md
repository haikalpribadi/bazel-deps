...
- package and target label naming convention uses hypens (e.g. `package-name:target-name`), rather than underscores (e.g. `package_name:target_name`, aka. `snake_case`).
